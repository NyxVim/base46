...
- It should be used along with [NyxVim](https://github.com/NyxVim/NyxVim) for best experience.
- Non NyxVim users can have the nyxconfig module on the path
...
- Base46 is configured by [nyxconfig](https://github.com/NyxVim/ui/blob/main/lua/nyxconfig.lua) in your path. 
- Read the [theming docs](https://nyxvim.one/docs/config/theming)
...
-- this will be later used for users to override your theme table from nyxrc
...
- Send PR in the https://github.com/NyxVim/base46/tree/main/lua/base46/themes

### Testing your theme

- Just place your theme file in your `/lua/themes` folder
- And select the theme with theme switcher or change in nyxrc
